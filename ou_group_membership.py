...
print(" ")
print("Pulling OU Group Information")

# Get AD Group and Membership
cstADGroup = ad_pull_group_by_objectGuid("60eec494-95cc-428d-aacf-eee91f0e9999")
...
# Get AD User1's DN
adUsr1_dn = ad_pull_user_dn_by_userid("cmderr")
print(adUsr1_dn)
...
# Get AD User3's DN
adUsr3_dn = ad_pull_user_dn_by_userid("omen")
print(adUsr3_dn)
...
cstADGroupAfter = ad_pull_group_by_objectGuid("60eec494-95cc-428d-aacf-eee91f0e9999")
